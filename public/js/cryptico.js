...
function generatekeys() {
    if (document.getElementById('passphrase').value) {
        ...
        passphrase = generatePassphrase(128);
    }
...
// pass = generatePassphrase(128);
// pubkeyy = generatePubKey(pass);
// console.log(pubkeyy);
// enc = encryptMessage(pubkeyy, "hoi");
// console.log(enc);
//
// message = decryptMessage(enc.cipher, pass);
//
